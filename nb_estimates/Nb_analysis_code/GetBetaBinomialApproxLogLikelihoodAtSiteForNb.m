function log_likelihood_site_forNb = GetBetaBinomialApproxLogLikelihoodAtSiteForNb(nu_donor, nu_recipient, var_is_absent_from_recipient, var_calling_threshold, Nb)
